...
<html>
    <head>
        ...
        <title>Immunization - Sign Up Successful</title>
                ...
                <main role="main" class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                    ...
                    <div class="card border-success mb-3" style="width: 60rem; padding: 10px;">
                        <div class="alert alert-success alert-dismissible fade show" role="alert">
                            Account created successfully <a href="/AdministratorController?admin_action=goToDashboard&sessionId=<%=sessionId%>"><< Back</a>
                        </div>
                    </div>
