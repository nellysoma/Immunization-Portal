            ...
            <div class="row">
                ...
                <main role="main" class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                        <h1 class="h2">Vaccination Site Created Successful</h1>
                    </div> 
                    <div class="card border-success mb-3" style="width: 60rem; padding: 10px;">
                        <div class="alert alert-success alert-dismissible fade show" role="alert">
                            Vaccination Site Created successfully <a href="/AdministratorController?admin_action=goToDashboard&sessionId=<%=sessionId%>"><< Back</a>
                        </div>
                    </div>
